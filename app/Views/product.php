...
<div class="container-home">
    <div class="banner_page banner_page_about">
        <img src="<?= base_url('images/heading_banner_product.svg'); ?>" alt="About Zabeera">
    </div>
    <div class="product_details_container">
        <div class="product_details">
            ...
            <div class="product_details_image">
                <img src="<?= base_url('images/product_page_1.png'); ?>" class="img_cover" alt="">
            </div>
        </div>
        <div class="product_details">
            <div class="product_details_image">
                <img src="<?= base_url('images/product_page_2.png'); ?>" class="img_cover" alt="">
            </div>
        ...
        <div class="product_details">
            ...
            <div class="product_details_image">
                <img src="<?= base_url('images/product_page_3.png'); ?>" class="img_cover" alt="">
            </div>
        </div>
    </div>
